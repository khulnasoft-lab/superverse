...
from superverse.annotators.utils import (PENDING_TRACK_ID, ColorLookup, Trace,
                                         resolve_color,
...
from superverse.detection.utils import (clip_boxes, mask_to_polygons,
                                        polygon_to_mask, spread_out_boxes,
                                        xyxy_to_polygons)
from superverse.draw.color import Color, ColorPalette
from superverse.draw.utils import (draw_polygon, draw_rounded_rectangle,
                                   draw_text)
...
from superverse.utils.image import (crop_image, letterbox_image, overlay_image,
                                    scale_image)
...
class CropAnnotator(BaseAnnotator):
    ...
    def annotate(
        ...
        ![crop-annotator-example](https://media.khulnasoft.com/
        superverse-annotator-examples/crop-annotator-example.png)
        """
        assert isinstance(scene, np.ndarray)
        crops = [
...
class ComparisonAnnotator:
    ...
    def annotate(
        ...
        ![comparison-annotator-example](https://media.khulnasoft.com/
        superverse-annotator-examples/comparison-annotator-example.png)
        """
        assert isinstance(scene, np.ndarray)
